...
pub fn bottom_toolbar(
    ...
    TopBottomPanel::bottom("toolbar").show(ctx, |ui| {
        ui.horizontal(|ui| {
            ...
            let filter_label = if config.linear_filter { "Linear" } else { "Nearest" };
            ui.label(format!("{} | {} | {} | {} | {} | [{} {}] | {}", parent_name, short, file_size, res_str, day_str, sort_label, sort_icon, filter_label));
