...
impl DefaultArchiveReader {
    ...
    fn init_pdfium(&self) -> Result<Pdfium> {
        static BINDINGS: std::sync::OnceLock<PdfiumLibraryBindings> = std::sync::OnceLock::new();
        ...
        let bindings = BINDINGS.get_or_init(|| {
            ...
            Pdfium::bind_to_library(Pdfium::pdfium_platform_library_name_at_path(exe_dir.to_str().unwrap_or("./")))
