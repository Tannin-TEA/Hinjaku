...
impl Navigator {
    ...
    pub fn go_next(&mut self, manga_mode: bool, manga_shift: bool, is_spread: impl Fn(usize) -> bool) -> bool {
        ...
        let step = if manga_mode {
            ...
            else if is_spread(self.target_index) || is_spread(self.target_index + 1) { 1 }
            else { 2 }
        } else { 1 };
