...
impl DefaultArchiveReader {
    fn init_pdfium(&self) -> Result<Pdfium> {
        ...
        // DLLをバインドする。bindings は Box<dyn PdfiumLibraryBindings> を返す。
        let bindings = Pdfium::bind_to_library(Pdfium::pdfium_platform_library_name_at_path(exe_dir.to_str().unwrap_or("./")))
